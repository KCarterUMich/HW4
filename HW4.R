...
ggplot(cars93, aes(x = Price, y = Fuel.tank.capacity)) +
  ...
  scale_y_continuous(name = "fuel-tank capacity\n(US gallons)") +
  ggtitle("Smoothing Method: Linear Model (lm)")


#GLM - SE - WITH COLOR - TITLE
ggplot(cars93, aes(x = Price, y = Fuel.tank.capacity)) +
  geom_point(color = "grey60") +
  geom_smooth(se = TRUE, method = "glm", color = "#fe8d6d") +
  scale_x_continuous(
  ...
  scale_y_continuous(name = "fuel-tank capacity\n(US gallons)") +
  ggtitle("Smoothing Method: Generalized Linear Model (glm)")


#GAM - SE - WITH COLOR - TITLE 
ggplot(cars93, aes(x = Price, y = Fuel.tank.capacity)) +
  geom_point(color = "grey60") +
  geom_smooth(se = TRUE, method = "gam", formula = y ~ s(x), color = "#7c6bea") +
  scale_x_continuous(
  ...
  scale_y_continuous(name = "fuel-tank capacity\n(US gallons)") +
  ggtitle("Smoothing Method: Generalized Additive Model (gam)")

#LM - SE - WITH COLOR - TITLE - FONT14
ggplot(cars93, aes(x = Price, y = Fuel.tank.capacity)) +
  geom_point(color = "grey60") +
  geom_smooth(se = TRUE, method = "lm", color = "#8fe388") +
  scale_x_continuous(
...
#GLM - SE - WITH COLOR - TITLE - FONT14
ggplot(cars93, aes(x = Price, y = Fuel.tank.capacity)) +
  geom_point(color = "grey60") +
  geom_smooth(se = TRUE, method = "glm", color = "#fe8d6d") +
  scale_x_continuous(
...
#GAM - SE - WITH COLOR - TITLE - FONT14
# install.packages("mgcv")  # Uncomment this line if you need to install the package
library(mgcv)
